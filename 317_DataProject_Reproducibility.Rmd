...
The function sends requests to the Gemini API, processes the responses, and returns the generated text along with sentiment analysis results. More information of the source code can be found here: 
https://github.com/wilkflow/qssProj/blob/main/317_Gemini_LLM.R 
