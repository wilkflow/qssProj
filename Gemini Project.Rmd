...
ggplot(plt, aes(Prediction,Gemini, fill= Freq)) +
        ...
        scale_x_discrete(labels=c("anger", "boredom", "empty", "enthusiasm", "fun", "happiness", "hate", "love","neutral", "relief", "sadness", "surprise","worry")) +
        scale_y_discrete(labels=c("anger", "boredom", "empty", "enthusiasm", "fun", "happiness", "hate", "love","neutral", "relief", "sadness", "surprise","worry"))
