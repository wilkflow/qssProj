...
```{r}
#wordcloud(names(sentiment_freq), freq = sentiment_freq, scale = c(3, 0.5), max.words = 100, random.order = FALSE, colors = brewer.pal(8, "Dark2"))
```

### Word Cloud Gemini

```{r}
#wordcloud(names(sentiment2_freq), freq = sentiment2_freq, scale = c(3, 0.5), max.words = 100, random.order = FALSE, colors = brewer.pal(8, "Set3"))
```
